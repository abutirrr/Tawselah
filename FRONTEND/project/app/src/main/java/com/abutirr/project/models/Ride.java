...
public class Ride {
     ...
     * @param updatedAt
     */
    public Ride(Integer rideId, Integer driverId, String sourceCity, String destinationCity, String sourcePin, String destinationPin, String rideTime, String rideDate, Double price, Integer seatsBooked, Integer seatsAvailable, Object createdAt, Object updatedAt, Driver driver) {
        super();
        this.rideId = rideId;
